...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition
{
    public class MediaManager : IService, IMediaManager
    {
        ...
        //public AudioClip recordClip; //by Jeon
        ...
        //public GameObject recoder;
        public Recording rec;
        public AudioVisualizer vis;
        ...
        public void Init()
        {
            ...
            rec = GameObject.FindGameObjectWithTag("Recorder").GetComponent<Recording>();
            vis = GameObject.FindGameObjectWithTag("Recorder").GetComponent<AudioVisualizer>();
            CheckMicrophones();
        }
        ...
        public void StartRecord()
        {
            ...
            _microphoneWorkingAudioClip = Microphone.Start(_microphoneDevice, true, 7, _speechRecognitionManager.CurrentConfig.sampleRate);

            //////visualize
            GameObject.FindGameObjectWithTag("Recorder").GetComponent<AudioSource>().clip = _microphoneWorkingAudioClip;
            vis.VisualizeVoice();
        ...
        public void StopRecord()
        {
            ...
            //recordClip = _microphoneWorkingAudioClip;
            
            // Debug.Log(rec);

            rec.SaveWave(_microphoneWorkingAudioClip);
