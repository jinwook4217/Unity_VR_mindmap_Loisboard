...
public class GvrReticlePointer : MonoBehaviour {
  ...
  private int _reticleSegments;

  /// Growth speed multiplier for the reticle/
  private float _reticleGrowthSpeed;
  ...
  void Start() {
    ...
    _reticleSegments = reticleManager.reticleSegment;
    _reticleGrowthSpeed = reticleManager.reticleGrowthSpeed;
  ...
  private void CreateReticleVertices() {
    ...
    int segments_count = _reticleSegments;
  ...
  private void UpdateReticleProperties() {
    ...
    reticlePointerImpl.ReticleGrowthSpeed = reticleManager.reticleGrowthSpeed;
    reticlePointerImpl.PointerTransform = transform;
  }


  
  public void ConnectFunction1(float reticleSizeValue)
  {
    reticlePointerImpl.MakeReticleOnce(reticleSizeValue);
  }

  public void ConnectFunction1()
  {
    reticlePointerImpl.MakeReticleOnce();
  }

  public void ConnectFunction2()
  {
    reticlePointerImpl.RemoveReticleOnce();
  }
